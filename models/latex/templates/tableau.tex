...
\usepackage[notext, nomath]{kpfonts-otf}
\setsansfont{KpSans-Regular}[
    UprightFont = *,
    BoldFont = *,       % On utilise la même fonte pour le gras (pas de chargement de fichier Bold)
    ItalicFont = *,     % Idem pour l'italique
    BoldItalicFont = *,
    Numbers = {Monospaced},
    Ligatures = TeX
]
...
\tiny
\begin{tblr}{colspec={Q[l,m,2.5cm] *{\VAR{nb_colonnes-1}}{Q[c,m,\VAR{larg_colonne} cm]} X[c,m]},row{even} = {gris},rows={ht=6mm,font=\tiny}}
